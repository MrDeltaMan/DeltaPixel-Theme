...
Este projeto não seria possível sem o trabalho incrível de outros artistas. Confira os detalhes completos no arquivo [CREDITS.txt](https://github.com/MrDeltaMan/DeltaPixel-Theme/blob/main/CREDITS).
